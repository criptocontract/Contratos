...
/**
  *   ______   __   __       __     __   __   ______   ______   ______   ______   _____                  
 *  /\  __ \ /\ "-.\ \     /\ \  _ \ \ /\ \ /\___  \ /\___  \ /\  __ \ /\  == \ /\  __-.                
 *  \ \  __ \\ \ \-.  \    \ \ \/ ".\ \\ \ \\/_/  /__\/_/  /__\ \  __ \\ \  __< \ \ \/\ \               
 *   \ \_\ \_\\ \_\\"\_\    \ \__/".~\_\\ \_\ /\_____\ /\_____\\ \_\ \_\\ \_\ \_\\ \____-               
     ...
     *     /\ \_\ \ /\ \ /\  ___\ /\  __ \ /\ \/ /  /\  __ \      *
      *    \ \  __ \\ \ \\ \___  \\ \ \/\ \\ \  _"-.\ \  __ \      
            \ \_\ \_\\ \_\\/\_____\\ \_____\\ \_\ \_\\ \_\ \_\    
             \/_/\/_/ \/_/ \/_____/ \/_____/ \/_/\/_/ \/_/\/_/  // O MAGO   
            
            "If we don't have freedom, we are nothin' but slaves"
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 14 * (10 ** 18);
...
contract BBOYS is IBEP20, Auth {
    ...
    address devFeeReceiver = 0xdc22ad987c78f9F44617C3ef222E8c4a32C6Cc8F;
    address devFeeReceiver1 = 0x9c4E656e4b9B77426C656aF04f76E7BBD2b2E3eb;
    
    address charity = 0x995f47000aB8B5136Ec948c3FDc7A4B0Bd7dFC15;
    address marketingFeeReceiver = 0xAd8cFD63053389EEa84a606Fd9AAfBA2265a9844;


    string constant _name = "Back Street BUSDs";
    string constant _symbol = "BBOYS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 20000000000 * (10 ** _decimals); // 2,000,000,000
...
// sending tokens to Devs
            (success, ) = payable(devFeeReceiver).call{value: amountDev, gas: 30000}("");
    ...
    function setFees(
        ...
        emit FeesUpdated(_enabled, _liquidityFee, _buybackFee, _reflectionFee, _marketingFee, _devFee, feeDenominator);
    }
